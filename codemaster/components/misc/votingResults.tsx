...
export default function VotingResults({winingData, language, colorTheme} :
  ...
  return (
    <div className="flex flex-col w-screen gap-6 p-2 mt-4 lg:max-w-5xl lg:w-full">
      <h1 className="text-2xl font-semibold text-left">Voting Results:</h1>
      
      {/* 1st Place */}
      <div className="flex flex-row w-full gap-0 overflow-x-auto bg-gray-200 rounded-md">
        <div className="flex flex-col gap-3 mt-5 ml-2 w-fit">
          <Image src={gold_medal} alt="gold medal" width={150} height={150} />
          <div className="flex flex-row w-full gap-2">
            <h1 className="mt-1 text-base font-semibold text-left lg:text-lg">{`By:  ${winingData[0].username}`}</h1>
            <ProfilePic username={winingData[0].username} style={{width: "30px", height: "30px"}} />
          </div>
          <h1 className="text-base font-semibold text-left lg:text-lg">{`XP Awarded: ${winingData[0].score}`}</h1>
        </div>
      ...
      <div className="flex flex-row w-full gap-0 overflow-x-auto bg-gray-200 rounded-md">
        <div className="flex flex-col gap-3 mt-5 ml-2 w-fit">
          ...
          <div className="flex flex-row w-full gap-2">
            <h1 className="mt-1 text-base font-semibold text-left lg:text-lg">{`By:  ${winingData[1].username}`}</h1>
            <ProfilePic username={winingData[1].username} style={{width: "30px", height: "30px"}} />
          </div>
          <h1 className="text-base font-semibold text-left lg:text-lg">{`XP Awarded: ${winingData[1].score}`}</h1>
        </div>
      ...
      <div className="flex flex-row w-full gap-0 overflow-x-auto bg-gray-200 rounded-md">
        <div className="flex flex-col gap-3 mt-5 ml-2 w-fit">
          ...
          <div className="flex flex-row w-full gap-2">
            <h1 className="mt-1 text-base font-semibold text-left lg:text-lg">{`By:  ${winingData[2].username}`}</h1>
            <ProfilePic username={winingData[2].username} style={{width: "30px", height: "30px"}} />
          </div>
          <h1 className="text-base font-semibold text-left lg:text-lg">{`XP Awarded: ${winingData[2].score}`}</h1>
        </div>
